...
class OptimizationParams(ParamGroup):
    ...
    def extract(self, args):
        g = super().extract(args)
        # g.l1_weight = args.Ll1_weight
        # g.lambda_dssim = args.Lssim_weight
        # g.densify_until_iter = args.densify_iter
        # g.densify_grad_threshold = args.densify_grad_threh
        # g.iterations = args.iters
        # g.percent_dense = args.per_dense
