...
# RGB0025fps exp:
# python train.py  -s /nobackup3/aryan/dataset_moped2/rgb0025fps/train \
#     --densify_until_iter 20000 --iterations 50000 --position_lr_final 0.00000001 --scaling_lr 0.0025
