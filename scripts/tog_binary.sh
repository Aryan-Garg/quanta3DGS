...
python train.py -s /nobackup3/aryan/dataset/binary/f1000/train \
    --start_checkpoint /nobackup3/aryan/HDRSplat/output/moped_graded_till200_default/point_cloud/iteration_50000/point_cloud.ply --is_binary \
    --iterations 60000 --save_iterations 60000